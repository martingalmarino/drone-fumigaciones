...
// Lazy load de CenterList
const CenterList = dynamic(() => import('@/components/CenterList').then(mod => ({ default: mod.CenterList })), {
  loading: () => <div className="h-96 bg-neutral-100 rounded-lg flex items-center justify-center">Cargando lista...</div>,
  ssr: false
})
...
export function MapaInteractive({ jurisdicciones }: MapaInteractiveProps) {
