...
interface JurisdictionLayoutClientProps {
  jurisdiccion: Jurisdiccion
  children: React.ReactNode
}

export function JurisdictionLayoutClient({ jurisdiccion, children }: JurisdictionLayoutClientProps) {
  ...
  const tabs = [
    {
      ...
      label: 'Grabado',
      icon: FileText,
      href: `/j/${jurisdiccion.slug}/grabado`
    },
    {
      id: 'rpa-rpm',
      label: 'RPA/RPM',
      icon: Calendar,
      href: `/j/${jurisdiccion.slug}/rpa-rpm`
    },
    {
      id: 'cedulas',
      label: 'Cédulas',
      icon: HelpCircle,
      href: `/j/${jurisdiccion.slug}/cedulas`
    },
    {
      id: 'centros',
      label: 'Centros',
      icon: MapPin,
      href: `/j/${jurisdiccion.slug}/centros`
    }
  ]
